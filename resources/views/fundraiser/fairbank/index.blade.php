    ...
    <style>
        @media(max-width: 600px){
            ...
            <div class="banner h-100" >
               <img src="{{url('assets/fundraiser/fairbankbanner.jpg?v=1')}}" class="w-100">
            </div>
            <form action="{{route('fairbank2024-ready-to-pickup')}}" method="POST" id="add-cart"> @csrf </form>
                                    ...
                                    <div class="card h-100 ">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="text-center">
                                                ...
                                                <h6 class="fw-bolder text-capitalize">{{$productVari->variation_name}}</h6>
