        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="card">
                <div class="row w-100 m-0">
                    <form action="{{route('add-cart')}}" method="POST" id="datechoose" />
            ...
            <div class="ps-3 pe-3 text-center">
                <div class="row mt-3 mb-3">
                    ...
                    <a class=" btn btn-outline-dark border border-dark-subtle text-uppercase rounded-5 btn-block p-3 mb-2" href="{{route('fundraiser')}}">Back to home</a>
