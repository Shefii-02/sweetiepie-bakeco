...
@extends('layouts.with-out-header')
@section('styles')
                    ...
                    <div class="card">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                id="BillingRadioaddress{{ $item->id }}" @checked($defaultChecked)>
                                ...
                                @else
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 form-group mb-3">
                                            ...
                                            <input class="form-control" autocomplete="off" type="text"  value="{{old('b_address')}}"
                                                name="b_address" id="b_address" placeholder="" required>
                                        </div>

                                        <div class="col-lg-6 form-group mb-3">
                                            <label for="">Postal Code</label>
                                            <input class="form-control" autocomplete="off" type="text"  value="{{old('b_postal')}}"
                                        ...
                                        <div class="col-lg-6 form-group mb-3">
                                            ...
                                            <input class="form-control" autocomplete="off" type="text" name="b_city"   value="{{old('b_city')}}"
                                                id="b_city" placeholder="" required>

                                        </div>
                                        <div class="col-lg-6 form-group mb-3">
                                            <label>Province</label>
                                            <select name="b_province" class="form-control" id="b_province">
                                                    @foreach ($province as $province_items)
                                                        <option value="{{ $province_items->code }}" @if(old('b_province') == $province_items->code) selected @endif>
                                                            {{ $province_items->name }}
                                                        </option>
                                                    @endforeach
                        ...
                        @if ($basket->order_type != 'pickup')
                            <div class="col-lg-12 ps-3 mb-3">
                                ...
                                <label for="same-address-checkbox">Use us different address for delivery</label>
                            </div>

                            <div id="shipping-address-div" style="display: none;">
                                <div class="card-header " id="shippingHeading">
                                    <div class="row">
                                        <h2 class="col-6">Delivery Detail</h2>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        @else
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 form-group mb-3">
                                                    <label for="">Address</label>
                                                    <input class="form-control" autocomplete="off" type="text"   value="{{old('s_address')}}"
                                                        name="s_address" id="s_address" placeholder="">
                                                </div>

                                                <div class="col-lg-6 form-group mb-3">
                                                    <label for="">Postal Code</label>
                                                    <input class="form-control" autocomplete="off" type="text"   value="{{old('s_postal')}}"
                                                ...
                                                <div class="col-lg-6 form-group mb-3">
                                                    <label for="">City</label>
                                                    <input class="form-control" autocomplete="off" type="text"   value="{{old('s_city')}}"
                                                ...
                                                <div class="col-lg-6 form-group mb-3">
                                                    <label>Province</label>
                                                    <select name="s_province" class="form-control" id="s_province">
                                                       @foreach ($province as $province_items)
                                                            <option value="{{ $province_items->code }}" @if(old('s_province') == $province_items->code) selected @endif>
                                                                {{ $province_items->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                            ...
                            <div class="card mt-3">
                                <div class="card-header" id="giftBox">
                                    <div class="col-lg-12 mb-3">
                                        <input type="checkbox" data-bs-toggle="collapse" data-bs-target="#giftBoxDiv"
                                            id="make-gift-checkbox" name="make_gift_checkbox"
                                            onchange="toggleShippingAddress()">
                                        <label for="make-gift-checkbox"
                                            class="text-left mb-0 h6 fw-bolder cursor-pointer"> Make this a
                                            gift</label>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group mb-2">
                                                <label for="nameOnCard mb-2" class=" fw-bolder">Add a greeting
                                                    card</label>
                                                <div class="row">
                                            ...
                                            <div class="form-group mb-2">
                                                <label for="cardNumber mb-2" class=" fw-bolder">Add a Card
                                                    Message</label>
                ...
                @if (isset($items) && $items->count() > 0)
                    <div class="cart-purchased mt-3 mt-md-0">
                        ...
                        <div class="gift-apply">
                            ...
                            <button class="gift_card_apply">Apply</button>
                        </div>
                        <div class="sub-total">
                ...
                @if(!auth()->check())
                    <div class="form-check mt-3">
                        ...
                        <label class="form-check-label" for="clickedSignup" style="font-size:85%;">
                            <strong>Do you want to signup this details</strong>
                        </label>
                    </div>
                @endif
                <div class="text-start mb-3 me-3">
                    <button class="btn  btn-sm primary-btn mt-1"  form="place__order" type="submit">PLACE ORDER </button>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{url('myaccount/address/add')}}" method="POST" id="add_address" class="row">
                  @csrf()
                  ...
                  <div class="col-lg-12 form-group mb-2">
                      ...
                      <textarea autocomplete="off"  class="form-control" form="add_address" name="address"></textarea>
                  </div> 
                  <div class="col-lg-6 form-group mb-2">
                      <label class="mb-2" for="">Postal Code</label>
                      <input type="text" required autocomplete="off"  form="add_address" class="form-control" name="postalcode">
                  </div>
                  <div class="col-lg-6 form-group mb-2">
                      <label class="mb-2" for="">City</label>
                      <input type="text" required autocomplete="off"  form="add_address" class="form-control" name="city">
                  </div> 
                  <div class="col-lg-6 form-group mb-2">
                      <label class="mb-2" for="">Province</label>
                      <select form="add_address"  class="form-control" name="province">
                       @foreach ($province as $province_items)
                            <option value="{{ $province_items->code }}" @if(old('province') == $province_items->code) selected @endif>
                                {{ $province_items->name }}
                            </option>
                        @endforeach
                        </select>
