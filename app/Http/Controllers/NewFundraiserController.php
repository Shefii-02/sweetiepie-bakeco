...
class NewFundraiserController extends Controller
{
    public function index(){
        ...
        return view('fundraiser.sickkids.index',compact('products','basketItems'));
    }
    ...
    {        
        ...
        return view('fundraiser.sickkids.choose-date')->withBasket($basket)->with('postvars',serialize($request->all()))->withStore($store);;
